...
import { createAddAction, createMinusAction, createAddAsyncAction } from '../../redux/actions/sum'
  ...
  render() {
    return (
      <div>
        ...
        <h3>Current the Sum is: {this.props.count}, Total person is: {this.props.person}</h3>&nbsp;
...
export default connect(
    state => ({count: state.counter, person: state.allPersons.length}),
    {
        add: createAddAction,
